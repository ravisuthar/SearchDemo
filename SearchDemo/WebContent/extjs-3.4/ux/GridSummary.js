    ...
    refreshSummary : function() {
        ...
        if (!this.view.summaryWrap) {
            this.view.summaryWrap = Ext.DomHelper[this.position=='bottom' ? 'insertAfter' : 'insertBefore'](this.view.scroller, {
				...
				style   : (Ext.isIE ? 'overflow:auto;width:100%;overflow-y:hidden;height:' + ((Ext.getScrollBarWidth ? Ext.getScrollBarWidth() : this.scrollBarWidth) + 18 /* 18 = row-expander height */) + 'px;' : ''),
                tag     : 'div',
