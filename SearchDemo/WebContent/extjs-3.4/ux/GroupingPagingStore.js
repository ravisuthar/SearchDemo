 ...
 */
Ext.ns('Ext.ux.data');
Ext.ux.data.GroupingPagingStore = Ext.extend(Ext.data.GroupingStore, {
    destroy: function() {
        if (this.storeId) {
    ...
    constructor: function(config) {
    	 config = config || {};
        Ext.ux.data.GroupingPagingStore.superclass.constructor.call(this,config);
    },
    ...
    sortData: function(f, direction) {
        ...
        var st = (this.fields.get(f))?this.fields.get(f).sortType:'';
        console.log(st);
